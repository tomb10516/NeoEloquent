...
class Book extends Model {
    ...
    // I (tomb10516) added this relation because some functionality was being untested that can
    // now be tested with this relation
    public function author() {
        return $this->belongsTo('Vinelab\NeoEloquent\Tests\Functional\Relations\HasMany\Author', 'WROTE');
    }
...
//    }
    ...
    public function testCreatingSingleBilateralRelatedModels() {
        $author = Author::create(['name' => 'George R. R. Martin']);
        ...
        foreach ($novel as $book) {
            ...
            $bookModel = $edge->related();
            // this following line throws an exception if issue #104 is not fixed
            $bookModel->author()->associate($author)->save();
